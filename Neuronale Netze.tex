...
Nach der letzten Subsampling-Schicht müssen alle Ausgabematrizen abgeflacht werden (engl. \enquote{Flattening}), indem alle Zeilen jeder Matrix aneinandergereiht werden, wodurch ein eindimensionaler Vektor entsteht.

Dieser Vektor entspricht der Eingabe eines herkömmlichen neuronalen Netzes, bei dem jedes Neuron mit jedem Neuron der nächsten Schicht verbunden ist. In der Regel benötigt dieses Netz sogar nur eine versteckte Schicht, da sämtliche Eingaben bereits auf die relevantesten Informationen heruntergebrochen wurden und nur noch elementare boolesche Funktionen ausgeführt werden müssen.
